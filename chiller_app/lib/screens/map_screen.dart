...
class _MapScreenState extends State<MapScreen> {
  ...
  @override
  void initState(){
    //check if the user is logged in or not while opening the map screen
    getCurrentUser();
    super.initState();
  }
                ...
                child: Column(
                 ...
                 children: [
                   ...
                   Padding(
                     ...
                     child: SizedBox(
                       width: MediaQuery.of(context).size.width-40, //40 is padding from both sides, that's 20 for each side
                       child: AbsorbPointer(
